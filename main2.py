...
while True:
    ...
    if results.pose_landmarks:
        ...
        center_line = r_shoulder_coords[0] + int((l_shoulder_coords[0] - r_shoulder_coords[0])/2)


        if left_shoulder and right_shoulder :
            if left_line and center_line < left_line:
                right = 1
            if right_line and center_line > right_line:
                left = 1

            if center_line > left_line and center_line < right_line:
                flag_center = 1
        ...
        if prev_left == 0 and left == 1 or flag_center == 1 and prev_right == 1:
            pyautogui.press("left")
            print("left")
        if prev_right == 0 and right == 1 or flag_center == 1 and prev_left == 1:
            print("right")
        ...
        if flag_horizontal == 0:
            right_line = int(left_shoulder.x * w) + 20
            left_line = int(right_shoulder.x * w) - 20
